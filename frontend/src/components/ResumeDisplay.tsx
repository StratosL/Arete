    ...
    <div className="w-full max-w-4xl mx-auto p-6 space-y-8">
      ...
      <div className="bg-secondary/50 rounded-lg border p-6">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-[hsl(var(--h2-foreground))]">Personal Information</h3>
        </div>
      ...
      <div className="bg-secondary/50 rounded-lg border p-6">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-[hsl(var(--h2-foreground))]">Experience</h3>
        </div>
        <div className="space-y-6">
          {resumeData.experience.map((exp, index) => (
            <div key={index} className="border-l-2 border-blue-200 pl-4">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-2">
                <h4 className="font-semibold text-gray-900 dark:text-[hsl(var(--h2-foreground))]">{exp.title}</h4>
                <span className="text-sm text-gray-500">{exp.duration}</span>
              </div>
              <p className="text-blue-600 font-medium mb-2">{exp.company}</p>
              <ul className="list-disc list-inside space-y-1 mb-3">
                {exp.description.map((desc, i) => (
                  <li key={i} className="text-sm text-gray-600 dark:text-gray-300">{desc}</li>
                ))}
              </ul>
      ...
      <div className="bg-secondary/50 rounded-lg border p-6">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-[hsl(var(--h2-foreground))]">Skills</h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-medium text-gray-900 dark:text-[hsl(var(--h2-foreground))] mb-2">Technical Skills</h4>
            <div className="flex flex-wrap gap-2">
      ...
      <div className="bg-secondary/50 rounded-lg border p-6">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-[hsl(var(--h2-foreground))]">Projects</h3>
        </div>
        <div className="space-y-4">
          {resumeData.projects.map((project, index) => (
            <div key={index} className="border border-gray-100 rounded-lg p-4">
              <h4 className="font-semibold text-gray-900 dark:text-[hsl(var(--h2-foreground))] mb-2">{project.name}</h4>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside">
                    {project.impact_metrics.map((metric, i) => (
                      <li key={i} className="text-sm text-gray-600 dark:text-gray-300">{metric}</li>
                    ))}
                  </ul>
                </div>
              )}
      ...
      <div className="bg-secondary/50 rounded-lg border p-6">
        <div className="flex items-center space-x-2 mb-4">
          ...
          <h3 className="text-lg font-semibold text-gray-900 dark:text-[hsl(var(--h2-foreground))]">Education</h3>
        </div>
        <div className="space-y-4">
          {resumeData.education.map((edu, index) => (
            <div key={index} className="flex flex-col md:flex-row md:items-center md:justify-between">
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-[hsl(var(--h2-foreground))]">{edu.degree}</h4>
